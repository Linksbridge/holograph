...
const RoleTagInput = ({
  ...
  const s = {
    ...
    box: {
      ...
      background: '#fff', minHeight: '34px', cursor: 'text',
      boxSizing: 'border-box', width: '100%',
    },
    chip: {
      display: 'inline-flex', alignItems: 'center', gap: '4px',
      background: '#eff6ff', border: '1px solid #bfdbfe', borderRadius: '4px',
      padding: '1px 6px', fontSize: '12px', color: '#1d4ed8', whiteSpace: 'nowrap',
    },
    chipRemove: {
      cursor: 'pointer', color: '#93c5fd', fontSize: '14px', lineHeight: 1,
      background: 'none', border: 'none', padding: 0,
    },
    input: {
      border: 'none', outline: 'none', fontSize: '13px', flex: 1,
      minWidth: '80px', background: 'transparent', padding: '2px 0',
    },
    dropdown: {
